...
public class BigDecimalDemo {
    public static void main(String[] args) {
        ...
        System.out.println(d1 - d2 + "-> We don't want this");

        BigDecimal b1 = new BigDecimal("174.56");
        BigDecimal b2 = new BigDecimal("174.26");

        System.out.println(b1.subtract(b2) + "-> We want this");
        /* Above /|\
        You can't do b1-b2 here because these are objects not integers or doubles.
        So you have to use the method that's related with BigDecimal
         */
