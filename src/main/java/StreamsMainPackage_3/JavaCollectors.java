...
public class JavaCollectors {
    public static void main(String[] args) {
        ...
        //Supplier is a pre made function interface, example is in lambda
        System.out.println("********TOCOLLECTION()***********");
        /*
        In the past we printed directly,
        this method helps us to keep the data
         */
        List<Integer> numberList = numbers.stream()
                .filter(x -> x%2==0)
                .collect(Collectors.toCollection(ArrayList::new)); //Create a new ArrayList and put inside it
        ...
        Set<Integer> numberSet = numbers.stream()
                .filter(x -> x%2==0)
                .collect(Collectors.toCollection(HashSet::new)); //Create a HashSet and put inside it
        ...
        /*
        Difference between toCollection and toList or toSet is that toCollection is a bigger umbrella
        of all of these. Other than that, there isn't any difference. We will mostly use
        toList instead of toCollection
         */
        ...
        //Function here is a functional interface learned on lambda. toMap requires two inputs because
        ...
        //groupingBy() : is used for gruoping objects by some property and storing results in a map instance
        System.out.println("********GROUPINGBY()***********");
        Map<Type,List<Dish>> dishType = DishData.getAll().stream()
                .collect(Collectors.groupingBy(Dish::getMeat));
